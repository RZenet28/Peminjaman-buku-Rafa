        ...
        @forelse($books as $book)
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="card h-100 border-0 shadow-sm hover-lift">
                    <!-- Book Cover -->
                    <div class="position-relative" style="height: 280px; overflow: hidden; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                        @if($book->gambar)
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <div class="d-flex justify-content-between align-items-center small mb-1">
                                ...
                                <strong class="text-danger">Rp {{ number_format($book->denda_hilang, 0, ',', '.') }}</strong>
                            </div>
                            <div class="d-flex justify-content-between align-items-center small">
                                <span class="text-muted">
                                    <i class="bi bi-exclamation-triangle me-1"></i>Denda Rusak:
                                </span>
                                <strong class="text-warning">Rp {{ number_format($book->denda_rusak, 0, ',', '.') }}</strong>
                            </div>
                        </div>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <textarea name="deskripsi" class="form-control" rows="3" placeholder="Deskripsi singkat buku...">{{ $book->deskripsi }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" name="denda_hilang" class="form-control" value="{{ $book->denda_hilang }}" required>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" name="denda_rusak" class="form-control" value="{{ $book->denda_rusak }}" required>
                                    </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="nama_buku" class="form-control" placeholder="Masukkan judul buku" required>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="deskripsi" class="form-control" rows="3" placeholder="Deskripsi singkat buku..."></textarea>
                        </div>
